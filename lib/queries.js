...
export async function getPlayer(id) {
  try {
    const stats = `
        SELECT p."playerId",CONCAT(p."firstName.default", ' ', p."lastName.default") AS player_name,p."birthDate",p."birthCountry"
			 ,p."position"
			 ,p."sweaterNumber"
			--  ,p."currentAge"
        ...
        GROUP BY
            p."playerId",
            CONCAT(p."firstName.default", ' ', p."lastName.default"),
            p."birthDate",
            p."birthCountry",
            p."position",
            p."sweaterNumber"
