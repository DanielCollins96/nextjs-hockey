...
export function comparePlayersUrl(leftName, leftId, rightName, rightId) {
  return `${compareStartUrl(leftName, leftId)}/${encodeURIComponent(entitySlug(rightName, rightId))}`;
}
