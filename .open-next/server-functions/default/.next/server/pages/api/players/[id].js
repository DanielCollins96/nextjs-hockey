"use strict";(()=>{var t={};t.id=245,t.ids=[245],t.modules={145:t=>{t.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(t,e)=>{Object.defineProperty(e,"l",{enumerable:!0,get:function(){return function t(e,s){return s in e?e[s]:"then"in e&&"function"==typeof e.then?e.then(e=>t(e,s)):"function"==typeof e&&"default"===s?e:void 0}}})},172:(t,e,s)=>{s.r(e),s.d(e,{config:()=>u,default:()=>l,routeModule:()=>d});var a={};s.r(a),s.d(a,{default:()=>p});var r=s(1802),n=s(7153),i=s(6249);s(4210);var o=s(5584);async function p(t,e){try{let{id:s}=t.query,a=await (0,o.RC)(s);if(0===a.length)return e.status(404).json({error_message:"Player not found"});let r=await (0,o.Ug)(s);e.status(200).json({player:a,playerStats:r})}catch(t){console.log(t)}}let l=(0,i.l)(a,"default"),u=(0,i.l)(a,"config"),d=new r.PagesAPIRouteModule({definition:{kind:n.x.PAGES_API,page:"/api/players/[id]",pathname:"/api/players/[id]",bundlePath:"",filename:""},userland:a})},4210:(t,e,s)=>{s.d(e,{Z:()=>r});let a=new(require("pg")).Pool({user:process.env.DB_USER,password:process.env.DB_PASS,host:process.env.DB_URL,port:process.env.DB_PORT,database:process.env.DB_NAME,max:30,idleTimeoutMillis:3e4,connectionTimeoutMillis:8e3});a.on("error",(t,e)=>{console.error("Unexpected error on idle client",t)});let r=a},5584:(t,e,s)=>{s.d(e,{Bg:()=>r,Q6:()=>p,RC:()=>i,Ug:()=>n,u3:()=>o});var a=s(4210);async function r(t){try{let e=`
        ...
        `,e=await a.Z.query(t);return e=e.rows}catch(t){console.log({tst_er:t})}}},7153:(t,e)=>{var s;Object.defineProperty(e,"x",{enumerable:!0,get:function(){return s}}),function(t){t.PAGES="PAGES",t.PAGES_API="PAGES_API",t.APP_PAGE="APP_PAGE",t.APP_ROUTE="APP_ROUTE"}(s||(s={}))},1802:(t,e,s)=>{t.exports=s(145)}};var e=require("../../../webpack-api-runtime.js");e.C(t);var s=e(e.s=172);module.exports=s})();