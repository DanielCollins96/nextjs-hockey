...
SELECT DISTINCT 
  ...
  "positionCode"
FROM combined_data;
        `,a=await t.Z.query(s,[e]);return a=a.rows}catch(e){console.log(e)}}async function m(e){try{let s=`
...
FROM combined_goalie_data;
        ...
        LIMIT 200
        `,a=await t.Z.query(s,[e]);return a=a.rows}catch(e){console.log({tst_er:e})}}},5949:(e,s,a)=>{a.r(s),a.d(s,{default:()=>n});var t=a(997);a(6689);var i=a(6859),r=a.n(i);a(4298);class o extends r(){static async getInitialProps(e){return{...await r().getInitialProps(e)}}render(){return(0,t.jsxs)(i.Html,{lang:"en",children:[t.jsx(i.Head,{children:t.jsx("link",{rel:"icon",sizes:"96x96",href:"/images/Hockey-Net.svg"})}),(0,t.jsxs)("body",{className:"bg-gray-100",children:[t.jsx(i.Main,{}),t.jsx(i.NextScript,{})]})]})}}let n=o}};