      ...
      (<div className="w-full max-w-sm mx-auto mt-12">
        ...
        <p className="mt-3 mb-6 font-bold tracking-wide text-2xl">Sign up for an account</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="inline-block align-baseline font- text-sm">Have an account? <Link href="/login" className="font-bold text-blue-600 hover:text-blue-800">Sign in</Link></button>
          </div>
        </form>
      </div>)
    );
