    ...
    >
      ...
      <tfoot>
        {footerGroups.map((group) => (
          <tr {...group.getFooterGroupProps()} className="bg-slate-300 py-px text-center font-bold">
            {group.headers.map((column) => (
              <td {...column.getFooterProps()} className="border-black">{column.render("Footer")}</td>
            ))}
          </tr>
        ))}
      </tfoot>
