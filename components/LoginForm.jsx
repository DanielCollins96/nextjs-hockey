      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            type="email"
            {...register("email")}
            className="shadow appearance-none border outline-red rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          />
        </div>
        <div className="mb-2">
          <label
          ...
          <input
            type="password"
            {...register("password")}
            className="shadow appearance-none border outline-red rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="uppercase w-24 bg-blue-600 hover:bg-blue-700 text-white font-bold tracking-wide py-2 px-4 rounded focus:outline-none focus:shadow-outline disabled:opacity-20"
            type="submit"
          >
            {isSubmitting ? (
